...
public class ReportUI : MonoBehaviour
{
    ...
    {
        public ReportItem(string txt, string it, int max)
        {
            text = txt;
            type = "Item";
            item = it;
    ...
    {
        ReportItemList.Add(new ReportItem("'괴상한 덩어리' 3개를 줍자.", "Item_Mass", 3));
        ...
        ReportItemList.Add(new ReportItem("'괴식물의 열매'를 3개 모으자.", "Item_Fruit", 3));
        ...
        ReportItemList.Add(new ReportItem("'소형 워크벤치'를 제작하자.", "Item_Facility01", 1));
        ReportItemList.Add(new ReportItem("탈출포드에서 '막대' 연구를 완료하자.", 7));
        ReportItemList.Add(new ReportItem("'간이 전구'를 제작하자.", "Item_Bulb", 1));
